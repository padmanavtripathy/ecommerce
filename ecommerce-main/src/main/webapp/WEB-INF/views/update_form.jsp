		...
		<div class="card mx-4 mx-md-5 shadow-5-strong"
			...
			<div class="card-body py-5 px-md-5">
				...
				<div class="row d-flex justify-content-center">
					<div class="col-lg-8">
						<h2 class="fw-bold mb-5">Change Product Details</h2>
						<form action="${pageContext.request.contextPath }/handle-form" meyhod="POST">
						<input type="hidden" name="id" value="${product.id }">
							...
							<div class="form-outline mb-4">
								<input type="text" id="form3Example4" class="form-control" name="sid" value="${product.sid }"/> <label
									class="form-label" for="form3Example4">Seller id<sup style="color:red;">*</sup></label>
							</div>
							<div class="form-outline mb-4">
								<input type="text" id="form3Example4" class="form-control" name="image1" value="${product.image1 }"/> <label
									class="form-label" for="form3Example4">First image link<sup style="color:red;">*</sup></label>
							</div>
							<div class="form-outline mb-4">
								<input type="text" id="form3Example4" class="form-control" name="image2" value="${product.image2 }"/> <label
									class="form-label" for="form3Example4">Second image
									link</label>
							</div>
							<div class="form-outline mb-4">
								<input type="text" id="form3Example4" class="form-control" name="image3" value="${product.image3 }"/> <label
									class="form-label" for="form3Example4" >Third image link</label>
							</div>


							<!-- Submit button -->
							<a href="${pageContext.request.contextPath }/view-product"><button type="button" class="btn btn-primary btn-block mb-4">
								Back</button></a>
